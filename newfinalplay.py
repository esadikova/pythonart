...
colors2 = ['medium blue', 'medium violet red', 'cornflower blue', 'deep pink', 'spring green', 'salmon','yellow']
...
for i in range(5):
    ...
    t.pencolor(random.choice(colors2))
    for i in range(50):
        t.forward(200)
        t.left(123)
...
#spirals,loljkcoool fill in triangles now
